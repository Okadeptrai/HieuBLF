...
local OrionLib = loadstring(game:HttpGet(('https://raw.githubusercontent.com/Okadeptrai/HieuBl/refs/heads/main/HieuBlox.lua')))()
local Window = OrionLib:MakeWindow({Name = "HieuBlox", HidePremium = false, IntroText = "REINHUB Library", SaveConfig = true, ConfigFolder = "REIN HUB"})

OrionLib:MakeNotification({
	Name = "Hieu Blox",
	Content = "Choose Teams Bro?",
	Image = "rbxassetid://83653192991806",
	Time = 7
})

OrionLib:MakeNotification({
	Name = "Hieu Blox",
	Content = "Xem video nhớ like đăng ký ",
	Image = "rbxassetid://83653192991806",
	Time = 25
})
...
local W = Window:MakeTab({
    Name = "👋 Welcome",
    Icon = "rbxassetid://83653192991806",
    PremiumOnly = false
})
...
local Wld = Window:MakeTab({
    Name = "🌍 Di Chuyển Từng Sea",
    Icon = "rbxassetid://4483345998",
    PremiumOnly = false
})

local SV = Window:MakeTab({
    Name = "📈 Trạng thái nghiêm trọng",
    Icon = "rbxassetid://4483345998",
    PremiumOnly = false
})
...
W:AddLabel("Script By hieurbl")

local Section = W:AddSection({
    Name = "Update"
})

W:AddLabel("[+] hieurbl đăng kí đi!")
